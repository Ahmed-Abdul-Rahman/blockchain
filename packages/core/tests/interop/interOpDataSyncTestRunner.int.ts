...
/**
 * Data Sync interop suite: propagation → replication → pull routing → anti-entropy convergence.
 */
describe('Interop - Data Sync Tests', () => {
  ...
  describe('Convergence (Anti-Entropy)', () => {

...
For DeChat, `CONTEXT.md` already exists at the repo root. ADRs go in `docs/adr/`. Existing technical specs live in `docs/core/` — reference them but do not duplicate implementation detail into `CONTEXT.md`.
